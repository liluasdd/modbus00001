...
// #define SPI_sdo_state PAin(11)	// 数据输出						 PA11
...
// // #define SPI_CS PAout(2)	// 片选端口						PA2
// #define SPI_CS PBout(12)	// 片选端口						PA2
// #define SPI_SDI PAout(7)	// 数据输入						PA7
// #define SPI_SDI_RD PAin(7) // SDA单通道时候 作为数据输出	  PA7
// #define SPI_sdo_state PAin(6)	// 数据输出						 PA6
// // #define SPI_RST PAout(3)	// 复位  	    		 		PA3
// #define SPI_RST PBout(13)	// 复位  	    		 		PA3
// #define SPI_SCK PAout(5)	// 时钟							PA5
// #define SPI_DC PAout(4)	// 数据/命令      				PA4
// #define LCD_LED PBout(0)	// 背光 开关                     PB0
